...
Partiful 对旦聚旦很直接：旦聚旦如果要做复旦/上海/AI 成长型社交，不能只做内容或报名页，要做“校友小局发生器”。
...
2. **身份/名片信任层**：复旦校友、职业、项目、可公开介绍，不是陌生人乱入。
3. **活动后关系沉淀**：谁和谁见过、聊了什么、下一次适合什么主题，逐渐形成校友互助图谱。

### 对巢聚 / 租房

Partiful 对巢聚不是直接模板，但有一个关系启发：租房也需要“可信小局”。
...
巢聚别一开始做泛房源平台，可以先做“有身份边界的租房小圈子 + 可信中介名片 + 线下看房组织”。关系强度来自身份认证、共同城市/学校/公司、重复互助和声誉约束。
...
5. 旦聚旦如果借鉴 Partiful，第一版应该做“校友饭局 RSVP 页”，还是“AI 主理人活动助手”？我的判断：先做 RSVP + 身份名片 + 活动后 follow-up，别急着做完整社区。
